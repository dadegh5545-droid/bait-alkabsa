/* ==========================================================================
   ...
   حقول الطبق:
     ...
     price   : السعر الأساسي بالريال (شامل الضريبة)
...
var MENU = [
  ...
  /* ---------------- الأرز واللحوم ---------------- */
  {
    ...
    price: 85,
    emoji: '🍛',
    desc: 'أرز بسمتي بمرق الحاشي، مع قطع لحم طريّة وبهارات الكبسة البيتية.',
    tag: 'الأكثر طلباً',
    hot: true,
    prep: 25,
    sizes: [
      { id: 'single', label: 'وجبة فردية', delta: 0 },
      { id: 'family', label: 'صحن عائلي (٤ أشخاص)', delta: 145 }
    ],
    addons: [
  ...
  },
  {
    ...
    price: 75,
    emoji: '🍚',
    desc: 'لحم مطبوخ تحت الضغط مع أرز الحمراء والبهارات الحجازية.',
    prep: 25,
    addons: [
      { id: 'extra-meat', label: 'زيادة لحم', price: 30 },
      { id: 'salad',      label: 'سلطة خضراء', price: 12 }
...
var ORDER_CONFIG = {
  ...
  /* التوصيل مجاني فوق هذا المبلغ (0 = معطّل) */
  freeDeliveryOver: 200,

  /* أقل مبلغ للطلب */
  minOrder: 30,

  /* الفروع المتاحة للاستلام */
  branches: [
    { id: 'malaz',    name: 'فرع الملز',   area: 'شارع جرير، حي الملز' },
    { id: 'olaya',    name: 'فرع العليا',  area: 'طريق الملك فهد، حي العليا' },
    { id: 'qurtubah', name: 'فرع قرطبة',   area: 'طريق الشيخ جابر، حي قرطبة' }
  ]
};
