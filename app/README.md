...
يشغّل ١١٠ اختبارات على ملفات الموقع في الجذر (القائمة، البحث، السلة، الحجز، المعرض، فهرس الصور، منطق الرفع إلى GitHub) داخل jsdom — لا يحتاج متصفحاً ولا أدوات أندرويد ولا شبكة.
